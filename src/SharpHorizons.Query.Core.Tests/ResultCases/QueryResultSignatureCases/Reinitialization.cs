...
public class Reinitialization
{
    ...
    {
        var actual = InitialQueryResultSignature with { Source = source, Version = version };
    ...
    {
        var exception = Record.Exception(() => InitialQueryResultSignature with { Source = source, Version = version });
    ...
    private static QueryResultSignature InitialQueryResultSignature => new("NASA/JPL Horizons API", "1.2");
}
