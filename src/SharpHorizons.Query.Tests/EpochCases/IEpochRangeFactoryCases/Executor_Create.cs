...
{
    public static void NullStartEpoch_ArgumentNullException(IEpochRangeFactory factory)
    {
    ...
    public static void NullStopEpoch_ArgumentNullException(IEpochRangeFactory factory)
    {
    ...
    public static void NullStepSize_ArgumentNullException(IEpochRangeFactory factory)
    {
        var startEpoch = GetValidStartEpoch();
        var stopEpoch = GetValidStopEpoch();
    ...
    public static void StopEpochEarlierThanStartEpochAndNullStepSize_ArgumentNullException(IEpochRangeFactory factory)
    {
        var startEpoch = GetValidStartEpoch();
    ...
    public static void StopEpochEarlierThanStartEpoch_ArgumentException(IEpochRangeFactory factory)
    {
        var startEpoch = GetValidStartEpoch();
        var stopEpoch = GetEarlierStopEpoch();
        var stepSize = GetValidStepSize();
    ...
    public static void StopEpochSameAsStartEpoch_ArgumentException(IEpochRangeFactory factory)
    {
        var startEpoch = GetValidStartEpoch();
    ...
    private static void AnyError_TException<TException>(IEpochRangeFactory factory, IEpoch startEpoch, IEpoch stopEpoch, IStepSize stepSize) where TException : Exception
    {
    ...
    public static void Valid_ExactMatch(IEpochRangeFactory factory)
    {
        var startEpoch = GetValidStartEpoch();
        var stopEpoch = GetValidStopEpoch();
        var stepSize = GetValidStepSize();
