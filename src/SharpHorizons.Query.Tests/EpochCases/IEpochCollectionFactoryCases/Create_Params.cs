...
{
    [Fact]
    public void Null_ArgumentNullException() => Executor_Create_Params.Null_ArgumentNullException(GetService());

    [Fact]
    public void Valid_ExactMatch() => Executor_Create_Params.Valid_ExactMatch(GetService());
