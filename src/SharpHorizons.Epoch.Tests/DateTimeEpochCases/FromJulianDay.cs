...
{
    private static DateTimeEpoch Target(JulianDay julianDay) => DateTimeEpoch.FromJulianDay(julianDay);
    ...
    public void Convertible_ApproximateMatch(DateTimeEpoch epoch, JulianDay julianDay)
    {
