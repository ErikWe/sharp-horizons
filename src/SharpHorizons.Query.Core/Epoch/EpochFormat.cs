...
public enum EpochFormat
{
    ...
    Unknown,
    /// <summary>The <see cref="IEpoch"/> are formatted as <see cref="JulianDay"/> - the fractional number of days since { 12:00:00 UTC, January 1st, 4713 BCE, Julian calendar }.</summary>
    JulianDays,
    /// <summary>The <see cref="IEpoch"/> are formatted as <see cref="ModifiedJulianDay"/> - the fractional number of days since { 00:00:00 UTC, November 17th, 1858 CE, Gregorian calendar }.</summary>
