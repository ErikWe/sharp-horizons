...
public class FromString
{
    ...
    {
        var actual = MPCCometName.FromString(name);
    ...
    {
        var exception = Record.Exception(() => MPCCometName.FromString(name));
    ...
    {
        var exception = Record.Exception(() => MPCCometName.FromString(null!));
