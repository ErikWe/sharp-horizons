...
public readonly record struct MPCName
{
    ...
    /// <summary>Retrieves the <see cref="string"/> <see cref="Value"/> represented by the <see cref="MPCName"/>.</summary>
    /// <exception cref="InvalidOperationException"/>
    ...
    /// <summary>Constructs an <see cref="MPCName"/>, representing the <see cref="string"/> <paramref name="value"/>.</summary>
    /// <param name="value"><inheritdoc cref="Value" path="/summary"/></param>
    /// <exception cref="ArgumentException"/>
    /// <exception cref="ArgumentNullException"/>
    public static MPCName FromString(string value) => new(value);

    /// <inheritdoc cref="MPCName"/>
    /// <param name="value"><inheritdoc cref="Value" path="/summary"/></param>
    /// <exception cref="ArgumentException"/>
    /// <exception cref="ArgumentNullException"/>
    public static explicit operator MPCName(string value) => FromString(value);
