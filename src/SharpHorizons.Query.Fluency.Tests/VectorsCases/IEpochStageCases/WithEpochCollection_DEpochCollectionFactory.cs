namespace SharpHorizons.Tests.QueryCases.FluencyCases.VectorsCases.IEpochStageCases;
...
public class WithEpochCollection_DEpochCollectionFactory
{
    ...
    public void Valid_ExactMatch()
    {
        ...
        var actual = epochStage.WithEpochCollection(epochCollectionFactoryDelegate).Build();
