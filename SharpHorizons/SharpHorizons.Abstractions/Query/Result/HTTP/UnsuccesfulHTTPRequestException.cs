...
/// <summary>Represents an <see cref="Exception"/> that occurred when trying to apply the <see cref="HTTPQueryResult"/> of an unsuccessful HTTP request.</summary>
public sealed class UnsuccesfulHTTPRequestException : Exception
{
    ...
    public UnsuccesfulHTTPRequestException(Exception? innerException = null) : base($"The {nameof(HTTPQueryResult)} does not represent a successful HTTP query.", innerException) { }
