...
public interface IOriginStage
{
    ...
    /// <param name="majorObjectName">The <see cref="ObjectRadiiInterpretation"/> of a <see cref="MajorObject"/>, the center of which represents the <see cref="IOrigin"/> in the <see cref="IVectorsQuery"/>.</param>
    ...
    public abstract IEpochStage WithOrigin(ObjectRadiiInterpretation majorObjectName);
    ...
    /// <remarks>Prefer using the <see cref="MajorObjectID"/> of the <see cref="MajorObject"/>, if known - as using the <see cref="ObjectRadiiInterpretation"/> can result in multiple matches.</remarks>
    /// <exception cref="ArgumentException"/>
    public abstract IEpochStage WithOrigin(ObjectRadiiInterpretation majorObjectName, CylindricalCoordinate coordinate);
    ...
    /// <remarks>Prefer using the <see cref="MajorObjectID"/> of the <see cref="MajorObject"/>, if known - as using the <see cref="ObjectRadiiInterpretation"/> can result in multiple matches.</remarks>
    /// <exception cref="ArgumentException"/>
    public abstract IEpochStage WithOrigin(ObjectRadiiInterpretation majorObjectName, GeodeticCoordinate coordinate);
    ...
    /// <remarks>Prefer using the <see cref="MajorObjectID"/> of the <see cref="MajorObject"/>, if known - as using the <see cref="ObjectRadiiInterpretation"/> can result in multiple matches.</remarks>
    /// <exception cref="ArgumentException"/>
    public abstract IEpochStage WithOrigin(ObjectRadiiInterpretation majorObjectName, ObservationSiteID observationSiteID);
}
