...
/// <summary>Describes a query for <see cref="OrbitalStateVectors"/>, the <see cref="Position3"/> and <see cref="Velocity3"/>, of a <see cref="ITarget"/> relative to an <see cref="IOrigin"/>.</summary>
public interface IVectorsQuery
{
    /// <summary>The <see cref="ITarget"/>, for which the <see cref="OrbitalStateVectors"/> are queried.</summary>
    public abstract ITarget Target { get; }

    /// <summary>The <see cref="IOrigin"/>, relative to which the <see cref="OrbitalStateVectors"/> of the <see cref="ITarget"/> are expressed.</summary>
    ...
    /// <summary>Determines what units of length and time are used to express the resulting <see cref="OrbitalStateVectors"/>.</summary>
