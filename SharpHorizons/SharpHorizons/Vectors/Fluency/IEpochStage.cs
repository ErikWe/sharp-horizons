...
{
    /// <summary>Selects <paramref name="epochs"/> as the <see cref="IEpochSelection"/> in the <see cref="IVectorsQuery"/>.</summary>
    /// <param name="epochs">The <see cref="IEpochSelection"/> in the <see cref="IVectorsQuery"/>.</param>
    /// <exception cref="ArgumentNullException"/>
    public abstract IVectorsQuery WithEpochs(IEpochSelection epochs);
