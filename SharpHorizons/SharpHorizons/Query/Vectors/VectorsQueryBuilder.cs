...
internal sealed class VectorsQueryBuilder : IVectorsQueryBuilder
{
    ...
    IVectorsQuery IVectorsQueryBuilder.Build()
    {
    ...
    IVectorsQueryBuilder IVectorsQueryBuilder.SpecifyTarget(ITarget target) => Specify(target, (vectorsQuery) => vectorsQuery.Target = target, Validator.ValidateTarget);
    IVectorsQueryBuilder IVectorsQueryBuilder.SpecifyOrigin(IOrigin origin) => Specify(origin, (vectorsQuery) => vectorsQuery.Origin = origin, Validator.ValidateOrigin);
    IVectorsQueryBuilder IVectorsQueryBuilder.SpecifyEpochSelection(IEpochSelection epochSelection) => Specify(epochSelection, (vectorsQuery) => vectorsQuery.EpochSelection = epochSelection, Validator.ValidateEpochSelection);

    IVectorsQueryBuilder IVectorsQueryBuilder.SpecifyOutputFormat(OutputFormat outputFormat) => Specify(outputFormat, (vectorsQuery) => vectorsQuery.OutputFormat = outputFormat, Validator.ValidateOutputFormat);
    IVectorsQueryBuilder IVectorsQueryBuilder.SpecifyObjectDataInclusion(ObjectDataInclusion objectDataInclusion) => Specify(objectDataInclusion, (vectorsQuery) => vectorsQuery.ObjectDataInclusion = objectDataInclusion, Validator.ValidateObjectDataInclusion);
    IVectorsQueryBuilder IVectorsQueryBuilder.SpecifyReferencePlane(ReferencePlane referencePlane) => Specify(referencePlane, (vectorsQuery) => vectorsQuery.ReferencePlane = referencePlane, Validator.ValidateReferencePlane);
    IVectorsQueryBuilder IVectorsQueryBuilder.SpecifyReferenceSystem(ReferenceSystem referenceSystem) => Specify(referenceSystem, (vectorsQuery) => vectorsQuery.ReferenceSystem = referenceSystem, Validator.ValidateReferenceSystem);
    IVectorsQueryBuilder IVectorsQueryBuilder.SpecifyOutputUnits(OutputUnits outputUnits) => Specify(outputUnits, (vectorsQuery) => vectorsQuery.OutputUnits = outputUnits, Validator.ValidateOutputUnits);
    IVectorsQueryBuilder IVectorsQueryBuilder.SpecifyTableContent(VectorTableContent tableContent) => Specify(tableContent, (vectorsQuery) => vectorsQuery.TableContent = tableContent, Validator.ValidateTableContent);
    IVectorsQueryBuilder IVectorsQueryBuilder.SpecifyCorrection(VectorCorrection correction) => Specify(correction, (vectorsQuery) => vectorsQuery.Correction = correction, Validator.ValidateCorrection);
    IVectorsQueryBuilder IVectorsQueryBuilder.SpecifyTimePrecision(TimePrecision timePrecision) => Specify(timePrecision, (vectorsQuery) => vectorsQuery.TimePrecision = timePrecision, Validator.ValidateTimePrecision);
    IVectorsQueryBuilder IVectorsQueryBuilder.SpecifyValueSeparation(ValueSeparation valueSeparation) => Specify(valueSeparation, (vectorsQuery) => vectorsQuery.ValueSeparation = valueSeparation, Validator.ValidateValueSeparation);
    IVectorsQueryBuilder IVectorsQueryBuilder.SpecifyOutputLabels(OutputLabels outputLabels) => Specify(outputLabels, (vectorsQuery) => vectorsQuery.OutputLabels = outputLabels, Validator.ValidateOutputLabels);
    IVectorsQueryBuilder IVectorsQueryBuilder.SpecifyTimeDeltaInclusion(TimeDeltaInclusion timeDeltaInclusion) => Specify(timeDeltaInclusion, (vectorsQuery) => vectorsQuery.TimeDeltaInclusion = timeDeltaInclusion, Validator.ValidateTimeDeltaInclusion);
