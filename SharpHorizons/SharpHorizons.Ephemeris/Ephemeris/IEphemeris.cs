...
/// <summary>Represents an ephemeris of an object, with each <see cref="IEphemerisEntry"/> described as an instance of <typeparamref name="TEntry"/>. This is a list of <typeparamref name="TEntry"/>, ordered by <see cref="IEphemerisEntry.Epoch"/> (earliest first).</summary>
