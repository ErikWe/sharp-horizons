...
public interface IPositionalUncertaintyPOS : IVectorsEphemerisEntry
{
    /// <summary>The 1σ-uncertainty in the <see cref="Position3"/> in the radial, right-ascension, and declination directions.</summary>
