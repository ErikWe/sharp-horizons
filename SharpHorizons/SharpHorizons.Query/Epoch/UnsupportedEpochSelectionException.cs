...
public sealed class UnsupportedEpochSelectionException : Exception
{
    ...
    public UnsupportedEpochSelectionException() : base($"The {typeof(IEpochSelection).FullName} was not performed according to the expected {typeof(EpochSelectionMode).FullName}.") { }
    ...
    private UnsupportedEpochSelectionException(EpochSelectionMode expectedType) : base($"The {typeof(IEpochSelection).FullName} was not performed according to {typeof(EpochSelectionMode).FullName}.{expectedType}.") { }
