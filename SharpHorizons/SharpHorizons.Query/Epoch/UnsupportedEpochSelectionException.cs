...
public sealed class UnsupportedEpochSelectionException : Exception
{
    ...
    private UnsupportedEpochSelectionException(EpochSelectionMode expectedType) : base($"The {typeof(IEpochSelection).Name} was not performed according to {typeof(EpochSelectionMode).Name}.{expectedType}.") { }
