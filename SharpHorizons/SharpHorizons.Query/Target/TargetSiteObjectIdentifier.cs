...
public readonly record struct TargetSiteObjectIdentifier
{
    ...
    /// <summary>Validates the <see cref="TargetSiteObjectIdentifier"/> <paramref name="identifier"/>, and throws an <see cref="Exception"/> of type <typeparamref name="TException"/> if invalid.</summary>
    ...
    private static void Validate<TException>(TargetSiteObjectIdentifier identifier, ExceptionInstantiation<TException> exceptionInstantiation) where TException : Exception
    {
        try
        {
    ...
    /// <summary>Validates the <see cref="TargetSiteObjectIdentifier"/>, and throws an <see cref="InvalidOperationException"/> if invalid.</summary>
    /// <exception cref="InvalidOperationException"/>
    private void Validate() => Validate(this, InvalidOperationExceptionFactory.InvalidState<TargetSiteObjectIdentifier>);
    ...
    /// <exception cref="ArgumentException"/>
    public static void Validate(TargetSiteObjectIdentifier identifier, [CallerArgumentExpression(nameof(identifier))] string? argumentExpression = null) => Validate(identifier, ArgumentExceptionFactory.InvalidStateDelegate<TargetSiteObjectIdentifier>(argumentExpression));
}
