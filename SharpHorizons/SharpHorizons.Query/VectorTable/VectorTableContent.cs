...
public readonly record struct VectorTableContent
{
    ...
    /// <summary>Specifies what <paramref name="quantities"/> and associated <paramref name="uncertainties"/> are included in the result of a query for <see cref="IOrbitalStateVectors"/>.</summary>
