...
/// <summary>A <see cref="IQueryArgument"/> describing the command, or providing the <see cref="ITarget"/> for epehemris generation.</summary>
public interface ICommandArgument : IQueryArgument { }

/// <summary>A <see cref="IQueryArgument"/> describing <see cref="OutputLabels"/> in an <see cref="IElementsQuery"/>.</summary>
public interface IElementLabelsArgument : IQueryArgument { }
...
/// <summary>A <see cref="IQueryArgument"/> describing the <see cref="IEpochSelection"/> when using <see cref="EpochSelectionMode.Collection"/>.</summary>
...
/// <summary>A <see cref="IQueryArgument"/> describing <see cref="OutputLabels"/> in a <see cref="IVectorsQuery"/>.</summary>
public interface IVectorLabelsArgument : IQueryArgument { }
