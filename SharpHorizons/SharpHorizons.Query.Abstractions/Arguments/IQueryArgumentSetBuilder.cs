...
public interface IQueryArgumentSetBuilder
{
    ...
    /// <summary>Specifies the <see cref="IGenerateEphemerisArgument"/> of the <see cref="IQueryArgumentSet"/>.</summary>
    /// <param name="generateEphemeris">The <see cref="IGenerateEphemerisArgument"/> of the <see cref="IQueryArgumentSet"/>.</param>
    /// <exception cref="ArgumentException"/>
    /// <exception cref="ArgumentNullException"/>
    public abstract IQueryArgumentSetBuilder Specify(IGenerateEphemerisArgument generateEphemeris);
    ...
    /// <summary>Specifies the <see cref="ICalendarTypeArgument"/> of the <see cref="IQueryArgumentSet"/>.</summary>
    /// <param name="epochCalendar">The <see cref="ICalendarTypeArgument"/> of the <see cref="IQueryArgumentSet"/>.</param>
    /// <exception cref="ArgumentException"/>
    /// <exception cref="ArgumentNullException"/>
    public abstract IQueryArgumentSetBuilder Specify(ICalendarTypeArgument epochCalendar);

    /// <summary>Specifies the <see cref="ITimeSystemArgument"/> of the <see cref="IQueryArgumentSet"/>.</summary>
    /// <param name="timeSystem">The <see cref="ITimeSystemArgument"/> of the <see cref="IQueryArgumentSet"/>.</param>
    /// <exception cref="ArgumentException"/>
    /// <exception cref="ArgumentNullException"/>
    public abstract IQueryArgumentSetBuilder Specify(ITimeSystemArgument timeSystem);

    /// <summary>Specifies the <see cref="ITimeZoneArgument"/> of the <see cref="IQueryArgumentSet"/>.</summary>
    /// <param name="timeZone">The <see cref="ITimeZoneArgument"/> of the <see cref="IQueryArgumentSet"/>.</param>
    /// <exception cref="ArgumentException"/>
    /// <exception cref="ArgumentNullException"/>
    public abstract IQueryArgumentSetBuilder Specify(ITimeZoneArgument timeZone);
